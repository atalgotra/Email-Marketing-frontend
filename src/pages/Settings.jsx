    ...
    <>
      ...
      >
            ...
            {currentUser.role === 'superadmin' ? (
              <form onSubmit={handleCreateUser}>
                <div style={{ marginBottom: '1.2rem' }}>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>Full Name</label>
                  <input
                    type="text"
                    required
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '2rem', fontSize: '1.1rem', fontWeight: 700 }}>
              <ShieldCheck size={20} className="text-primary" /> SMTP Infrastructure
            </h3>
            {currentUser.role === 'superadmin' ? (
              <form onSubmit={handleSaveSmtp}>
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1rem', marginBottom: '1.2rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>SMTP Gateway Host</label>
                    <input
                      type="text"
                      className="premium-input"
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>Port</label>
                    <input
                      type="text"
                      className="premium-input"
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>System User</label>
                    <input
                      type="text"
                      className="premium-input"
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>System Password</label>
                    <input
                      type="password"
                      className="premium-input"
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <button type="submit" className="premium-btn" style={{ padding: '12px 24px' }}>Save Node Config</button>
                </div>
              </form>
            ) : (
              <div style={{ padding: '1rem', background: 'rgba(244, 63, 94, 0.05)', borderRadius: '12px', border: '1px solid rgba(244, 63, 94, 0.1)' }}>
                <p style={{ fontSize: '0.8rem', color: '#f43f5e', textAlign: 'center' }}>Infrastructure settings are locked for Administrators.</p>
              </div>
            )}
          </div>
        </div>
